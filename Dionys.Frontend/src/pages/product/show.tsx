        ...
        return (
            <Layout title={product && product.name ? product.name : "Product"}>
                ...
                <div className="actions">
                    <Button className="button" variant="contained" component={LinkAdapter} to={`/products/${this.props.id}/edit`}>
                        Edit
                    </Button>
                ...
                {this.state.loading ? <CircularProgress className="progress" /> : <ProductShow product={product} />}
