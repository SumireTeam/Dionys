...
class Edit extends React.Component<Props, State> {
    ...
    protected async onSubmit() {
        const consumed = this.state.consumed.id ? await this.service.update(this.state.consumed) : await this.service.create(this.state.consumed);
        ...
        return (
            <Layout title="Edit consumed product">
                ...
                <div className="actions">
                    <Button className="button" variant="contained" color="primary" component={LinkAdapter} to={`/consumed/${this.props.id}`}>
                        View
                    </Button>
