        ...
        return (
            <Layout title="Consumed product">
                ...
                <div className="actions">
                    <Button className="button" variant="contained" component={LinkAdapter} to={`/consumed/${this.props.id}/edit`}>
                        Edit
                    </Button>
                ...
                {this.state.loading ? <CircularProgress className="progress" /> : <ConsumedShow consumed={consumed} />}
